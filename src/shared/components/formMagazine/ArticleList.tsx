...
//                 <p className={`text-sm font-bold mt-1 ${article.isActive ? "text-green-600" : "text-red-600"}`}>
...
//                     className={`flex items-center px-3 py-1 rounded text-white transition ${
//                       article.isActive ? "bg-red-500 hover:bg-red-600" : "bg-green-500 hover:bg-green-600"
//                     }`}
//                   >
//                     {article.isActive ? <FaToggleOff className="mr-2" /> : <FaToggleOn className="mr-2" />}
