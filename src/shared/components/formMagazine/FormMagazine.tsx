...
//         <label className="block">
//           Descripción:
//           <textarea name="description" value={formData.description} onChange={handleChange} className="border p-2 w-full" required></textarea>
//         </label>
//         <label className="block">
//           📷 Subir Imagen:
...
//           disabled={!isAuthenticated} // Deshabilitar si no hay usuario autenticado
//         >
