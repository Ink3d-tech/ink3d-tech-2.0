...
const ProcductSweatshirt: React.FC<ProductListProps> = ({ category }) => {
  const products = allProducts[category] || [];

  return (
    <div className="max-w-9xl my-6 mx-6 bg-white rounded-lg">
      <h2 className="text-2xl font-semibold text-gray-800 text-left m-3">Buzos</h2>
...
export default ProcductSweatshirt;
