...
//                         )) 
//                         : products.slice(0, 4).map((product: ProductInterface) => (
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
                    {
                        ...
                        : products.slice(0, 4).map((product) => {
                            try {
                                if (!product.id) throw new Error(`Product ID is missing for product: ${product.name}`);
                                ...
                                console.error(error);
                                return null; // Ignora el producto si tiene un error
                            }
                        })
                    }
                </div>
