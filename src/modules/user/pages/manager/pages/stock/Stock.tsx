...
//     const size = movement.product.size;
...
//                     <th className="border p-2 text-left">Stock Actual</th>
//                     <th className="border p-2 text-left">Fecha de avastecimiento</th>
//                   </tr>
//                 </thead>
//                 <tbody>
//                   {filteredMovements.map((movement) => {
//                     if (!movement.product) return null;
//                     const stockInicial = movement.product.stock - (movement.type === "venta" ? -movement.quantity : movement.quantity);
//                     return (
//                       <tr
//                         key={movement.id}
//                         className="cursor-pointer hover:bg-gray-100"
...
//                         <td className="border p-2">{movement.product.name}</td>
//                         <td className="border p-2">{stockInicial}</td>
//                         <td className="border p-2">{Math.abs(movement.quantity)}</td>
//                         <td className="border p-2">{movement.product.stock}</td>
...
//                 Stock Inicial:{" "}
//                 <strong>
//                   {selectedMovement.product.stock -
//                     (selectedMovement.type === "venta" ? -selectedMovement.quantity : selectedMovement.quantity)}
//                 </strong>
//               </span>
//             </div>
...
//               <Package className="w-4 h-4 text-blue-500 mr-2" />
//               <span>
//                 Productos Vendidos: <strong>{Math.abs(selectedMovement.quantity)}</strong>
//               </span>
//             </div>
...
//               <Layers className="w-4 h-4 text-teal-500 mr-2" />
//               <span>
//                 Stock Actual: <strong>{selectedMovement.product.stock}</strong>
//               </span>
//             </div>
//           </div>
...
//                     // Stock Actual: Tomamos el "newStock" del último movimiento
//                     const stockActual =
//                       movimientosProducto.length > 0
//                         ? movimientosProducto[movimientosProducto.length - 1].newStock
//                         : 0;
