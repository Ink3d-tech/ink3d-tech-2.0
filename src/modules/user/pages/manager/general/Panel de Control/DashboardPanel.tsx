...
//   status: "active" | "expired" | "used" | "inactive";
//   userId: string | null;
//   maxUses: number; // Nuevo campo
//   currentUses: number; // Nuevo campo
// }
...
//   // Crear un descuento con expiración opcional
// const [newCode, setNewCode] = useState<string>(""); // Nuevo estado para el código
// const [newMaxUses, setNewMaxUses] = useState<string>("1"); // Nuevo estado para maxUses
...
//   if (!newCode.trim()) {
//     alert("Debe ingresar un código para el descuento.");
//     return;
//   }
...
//         status: "active",
//         expiresAt: expirationDate,
//         maxUses: Number(newMaxUses), // Nuevo campo
//       },
//       { headers: { Authorization: `Bearer ${token}` } }
//     );

//     setDiscounts([...discounts, response.data]); // response.data es del tipo 'Discount'
//     setNewAmount("");
...
//         `${API_BACK}/discounts/code/${searchId}`,
//         { headers: { Authorization: `Bearer ${token}` } }
//       );
